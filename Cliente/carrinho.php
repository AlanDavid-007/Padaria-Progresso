    ...
    <div id="summary" class="w-1/4 px-8 py-10 bg-white">
      ...
      <div>
        ...
        <div class="border-t mt-8"> ----->
          ...
          <a href="https://api.whatsapp.com/send?phone=5551992418400&amp;text=Olá, meu nome é <?php echo $_SESSION['primeiro_nome'];?>, f
                   iz um/s pedido/s no site!, aqui vai as informaçes:<?php foreach ($pedidos as $key => $value) { echo 'id=' . $value['id'] . '<br>' . 
  'nome=' . $value['produto_id']->nome . '<br>' . 'categoria=' . $value['categoria']->nome . '<br>' . 'quantidade=' . $value['quantidade'] . '<br>' . 
  'valor=' . $value['valor'] . '.';?>, ;source=&amp;data=&amp;app_absent=" target="_blank" rel="noopener noreferrer">
