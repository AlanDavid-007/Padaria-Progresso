...
<!-- products cart -->
<div class="container mx-auto mt-10 carrinho-desktop">
        ...
        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          <div class="flex w-2/5">
            ...
            <div class="flex flex-col justify-between ml-4 flex-grow">
             ...
             <form method="get">
              <button type="submit" id="excluir" name="id" value="<?php echo $value['id']; ?>" class="font-semibold hover:text-red-500 text-gray-500 text-xs">Remover</a>
              </form>
            </div>
          </div>
    ...
    <div id="summary" class="w-1/4 px-8 py-10 bg-white">
      ...
      <div>
        ...
        <div class="border-t mt-8"> ----->
          ...
          <a href="https://api.whatsapp.com/send?phone=5551992418400&amp;text=Olá, meu nome é <?php echo $_SESSION['primeiro_nome'];?>, 
          fiz um/s pedido/s no site!, aqui vai as informaçes:<?php echo 'id=' . $id . 
  ',nome=' . $nome  . ', categoria=' . $categoria . ', quantidade=' . $quantidade . 
  ', valor=' . $valor;?>, source=site&amp;data=&amp;app_absent=" target="_blank" rel="noopener noreferrer">
            <button type="button" class="btn bg-success btn-success d-flex justify-content-center text-center w-100" style="height: 50px;">
...
<div class="container mx-auto mt-10 carrinho-mobile">
    <div class="w-1/7 px-8 py-10 bg-white">
      <div class="flex justify-between border-b pb-8">
        <h1 class="font-semibold text-2xl">Carrinho</h1>
        <h2 class="font-semibold text-2xl"><?php echo count($pedidos); ?> Itens</h2>
      </div>
     ...
     <!-- summary -->
     <div id="summary-2" class="w-1/7 px-8 py-10 bg-white">
      <h1 class="font-semibold text-2xl border-b pb-8">Resumo</h1>
      <div class="flex justify-between mt-10 mb-5">
        <span class="font-semibold text-sm uppercase">Subtotal</span>
        <span class="font-semibold text-sm"><?php echo 'R$' . $subtotal . ',' . 0 . 0; ?></span>
