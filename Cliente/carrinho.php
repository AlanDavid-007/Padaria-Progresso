  ...
  <div class="row" style="background: white;">
    <div class="col-12 col-sm-6">
      ...
      <div class="flex mt-10 mb-5 row">
        ...
        <h3 class="font-semibold text-gray-600 text-xs uppercase w-1/5 col-12 col-sm-3" style="padding:10px;">Total</h3>
      </div>
    ...
    <div class="col-12 col-sm-6">
      ...
      <div>
        ...
        <div class="border-t mt-8"> ----->
          ...
          <a href="https://api.whatsapp.com/send?phone=5551992418400&amp;text=&amp;source=&amp;data=&amp;app_absent=" target="_blank" rel="noopener noreferrer" class="d-flex justify-content-center">
            <button type="button" class="btn bg-black btn-success d-flex justify-content-center text-center w-50" style="height: 50px;">
