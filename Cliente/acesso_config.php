...
//busca
$busca = filter_input(INPUT_GET, 'primeiro_nome');


//condiçoes sql 
$condicoes = [
    strlen($busca) ? 'primeiro_nome LIKE "%' . str_replace(' ', '%', $busca) . '%"' : null,
];
...
//  echo "<pre>"; print_r($_SESSION['primeiro_nome']); echo "</pre>"; exit;
    ...
    <form method="get">
        <div class="row alig-items-between">
            <div class="col text-light">
                ...
                <input type="text" name="primeiro_nome" class="form-control" value="<?= $busca ?>">
            </div>
...
<div class="h-full bg-gradient-to-tl from-black-400 to-gray-900 w-full py-16 px-4">
        <div class="flex flex-col items-center justify-center">
            <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                ...
                <p tabindex="0" class="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800"><?php echo $value->primeiro_nome;?></p>
                ...
                <a href="../Cliente/Editar/editar_usuarios.php?id=<?php echo $value->id;?>" class="text-base font-medium ml-4 text-gray-700">Mudar Informações</a>
                </button>
            </div>
        </div>
    </div>
