...
$acharUsuario = in_array($_SESSION['email'] , $email1);
 ...
 <div class="h-full bg-gradient-to-tl from-black-400 to-gray-900 w-full py-16 px-4">
        <div class="flex flex-col items-center justify-center">
            <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                ...
                <a href="../Cliente/Editar/editar_usuarios.php?id=<?php echo $acharUsuario;?>" class="text-base font-medium ml-4 text-gray-700">Mudar Informações</a>
                </button>
            </div>
        </div>
    </div>
