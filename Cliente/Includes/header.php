...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="../Cliente/estilo/style.css">
                ...
                <div class="dark:bg-gray-800 bg-gray-50 px-6 py-9">
                    <div class="container mx-auto flex items-center justify-between">
                        ...
                        <ul class="hidden w-8/12 md:flex items-center justify-center space-x-6 font-serif">
                            ...
                            <li>
                                <a href="../Cliente/acesso_config.php?primeiro_nome=<?php echo $_SESSION['primeiro_nome'];?>" class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800" style="text-decoration: none; font-size: 20px;">
                                    Configurações
                                </a>
                            </li>
                            <li>
                ...
                <div id="mobile-menu" class="hidden absolute dark:bg-gray-900 z-10 inset-0 md:hidden flex flex-col h-screen w-full">
                    ...
                    <div class="mt-6 p-4 ">
                        <ul class="flex flex-col space-y-6">
                            ...
                            <li>
                                <a href="../Cliente/acesso_config.php?primeiro_nome=<?php echo  $_SESSION['primeiro_nome'];?>" class="dark:text-white flex items-center justify-between hover:underline text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800" style="font-size: 20px;">
                                    Configurações
                                    <div>
                                        <img class="dark:hidden" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-I-svg7.svg" alt="arrow">
                                        <img class="dark:block hidden" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/navigation-I-svg7dark.svg" alt="arrow">
