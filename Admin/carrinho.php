    ...
    <div class="flex shadow-md my-10">
      <div class="w-3/4 bg-white px-10 py-10">
        ...
        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          <div class="flex w-2/5"> <!-- product -->
            ...
            <div class="flex flex-col justify-between ml-4 flex-grow">
              <span class="font-bold text-sm">Risóle</span>
          ...
          <span class="text-center w-1/5 font-semibold text-sm">R$5.00</span>
          <span class="text-center w-1/5 font-semibold text-sm">R$5.00</span>
        </div>
        ...
        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          <div class="flex w-2/5"> <!-- product -->
            <div class="w-20">
              <img class="h-24" src="./Assets/bolos.png" alt="">
            </div>
            <div class="flex flex-col justify-between ml-4 flex-grow">
              <span class="font-bold text-sm">Bolo</span>
              <span class="text-red-500 text-xs">Padaria Progresso</span>
              <a href="#" class="font-semibold hover:text-red-500 text-gray-500 text-xs">Remover</a>
            </div>
          </div>
          ...
          <span class="text-center w-1/5 font-semibold text-sm">R$40.00</span>
          <span class="text-center w-1/5 font-semibold text-sm">R$40.00</span>
        </div>
        ...
        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          <div class="flex w-2/5"> <!-- product -->
            <div class="w-20">
              <img class="h-24" src="./Assets/cucas.png" alt="">
            </div>
            <div class="flex flex-col justify-between ml-4 flex-grow">
              <span class="font-bold text-sm">Cuca</span>
              <span class="text-red-500 text-xs">Padaria Progresso</span>
              <a href="#" class="font-semibold hover:text-red-500 text-gray-500 text-xs">Remover</a>
            </div>
          </div>
          ...
          <span class="text-center w-1/5 font-semibold text-sm">R$10.00</span>
          <span class="text-center w-1/5 font-semibold text-sm">R$10.00</span>
        </div>
      ...
      <div style="background-color: #f6f6f6;" class="w-1/4 px-8 py-10">
        <h1 class="font-semibold text-2xl border-b pb-8">Resumo do pedido</h1>
        <div class="flex justify-between mt-10 mb-5">
          <span class="font-semibold text-sm uppercase">Items 3</span>
          <span class="font-semibold text-sm">55.00R$</span>
        </div>
        <div>
            <!-- Utilizar futuramente cep para calcular valor de frete -->
          <label class="font-medium inline-block mb-3 text-sm uppercase">Envio</label>
          <select class="block p-2 text-gray-600 w-full text-sm">
            <option>Envio padrão - R$10.00</option>
          </select>
        </div>
        <div class="py-10">
          <label for="promo" class="font-semibold inline-block mb-3 text-sm uppercase">Código de desconto</label>
