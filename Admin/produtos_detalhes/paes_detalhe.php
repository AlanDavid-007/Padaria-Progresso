...
<body class="dark:bg-gray-400">
  ...
  <div class="flex">
         <a href="../produtos/paes.php"> <button class="flex mr-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded" >Voltar</button></a>
          </button>
        </div>
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src="../Assets/paes.png">
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">Padaria Progresso</h2>
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Pão Frânces</h1>
        <div class="flex mb-4">
