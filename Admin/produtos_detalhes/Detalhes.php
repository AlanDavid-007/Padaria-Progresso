...
<?php foreach ($produtos as $key => $value && $feedbacks as $key => $feedback) { ?>
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex mb-4">
          <span class="flex items-center">
            ...
            <span class="text-gray-600 ml-3"><?php echo $feedback['nota'];?> Reviews</span>
          </span>
        ...
        <div class="flex">
          <span class="title-font font-medium text-2xl text-gray-900"><?php echo $valor ?></span>
          <button class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded"><a href="">Adicionar ao Carrinho</a></button>
          // Colocar link para adicionar ao carrinho
