...
<section class="formulario">
    ...
    <form method="post" class="form-send ">
        <div class="form-group">
            ...
            <input type="text" required class="form-control " style="width: 50%; margin-left:25%" name="nome" value="<?php echo isset($obCurso->nome) ? $obCurso->nome : ''; ?>">
        </div>

        <div class="form-group">
            <label style="margin-left:25%">Descrição</label>
            <textarea class="form-control" style="width: 50%; margin-left:25%" required name="palavra_chave" rows="5"><?php echo isset($obCurso->palavra_chave) ? $obCurso->palavra_chave : ''; ?></textarea>
        </div>

        <div class="form-group">
            <label style="margin-left:25%">Quantidade</label>
            <textarea class="form-control" style="width: 50%; margin-left:25%" required name="valor" rows="1"><?php echo isset($obCurso->valor) ? $obCurso->valor : ''; ?></textarea>
        </div>

        <div class="form-group">
            <label style="margin-left:25%">Tipo</label>
            <textarea class="form-control" style="width: 50%; margin-left:25%" required name="ordem" rows="1"><?php echo isset($obCurso->ordem) ? $obCurso->ordem : ''; ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" style="width: 50%; margin-left:25%" name="pedido" value="">
                ...
                <?php foreach ($listaPedidos as $key => $value) { ?>
                    <option value="<?php echo $value->id; ?>" <?php echo $obProduto->pedido_id == $value->id ? "selected" : ''; ?>> <?php echo $value->nome; ?></option>
                <?php } ?>
            </select>
        </div>
        <div class="form-group">
            ...
            <select class="form-control" style="width: 50%; margin-left:25%" name="promocoes" value="">
                ...
                <?php foreach ($listaPromocoes as $key => $value) { ?>
                    <option value="<?php echo $value->id; ?>" <?php echo $obProduto->promocoes_id == $value->id ? "selected" : ''; ?>> <?php echo $value->nome; ?></option>
                <?php } ?>
            </select>
        </div>
                ...
                <div class="dark:bg-gray-800 bg-gray-50 px-6 py-9">
                    <div class="container mx-auto flex items-center justify-between">
                        ...
                        <div class="flex flex-col">
                            ...
                            <a href="javascript:void(0)"
                                class="focus:outline-none focus:underline hover:text-gray-500 text-base mt-6 text-gray-800 dark:text-white cursor-pointer"><i class="fa-brands fa-whatsapp"></i>  51 995731335</a>
                            <a href="javascript:void(0)"
                                class="focus:outline-none focus:underline hover:text-gray-500 text-base mt-6 text-gray-800 dark:text-white cursor-pointer"><i class="fa-brands fa-instagram"></i>  @padariaprogresso</a>
                        </div>
