...
<div class="mx-auto container px-6 xl:px-0 py-12 ">
        <p class="uppercase text-center font-serif text-xl text-light">Confira os nossos doces!</p>
    </div>
    <hr>
    <div class="mx-auto container px-6 xl:px-0 py-12">
        <div class="flex flex-col">
            <div class="mt-10 grid </a>lg:grid-cols-2 gap-x-8 gap-y-8 items-center">
<a href="../produtos_detalhes/doces_detalhe.php"><div
                    ...
                    <img class="group-hover:opacity-60 transition duration-500" src="../Assets/doces.png"
                        alt="doces" />
                    <div
