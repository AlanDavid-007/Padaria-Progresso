...
<div class="mx-auto container px-6 xl:px-0 py-12 ">
        <p class="uppercase text-center font-serif text-xl text-light">Confira os nossos pães!</p>
    </div>
    <hr>
    <div class="mx-auto container px-6 xl:px-0 py-12">
        <div class="flex flex-col">
            <div class="mt-10 grid lg:grid-cols-2 gap-x-8 gap-y-8 items-center">
<a href="../produtos_detalhes/paes_detalhe.php"><div
                    ...
                    <img class="group-hover:opacity-60 transition duration-500" src="../Assets/paes.png"
                        alt="paes" />
                    <div
                ...
                <a href="../produtos_detalhes/paes</a>_detalhe.php"><div
                    class="group group-hover:bg-opacity-60 transition duration-500 relative bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 sm:p-28 py-36 px-10 flex justify-center items-center">
                    <img class="group-hover:opacity-60 transition duration-500" src="../Assets/paes.png"
                        alt="paes" />
                    <div
