                    ...
                    <div class='w-full md:w-full px-3 mb-6'>
                        ...
                        <div class="personal w-full border-t border-gray-400 pt-4 mt-3">
                            ...
                            <div class="flex items-center justify-between mt-4">
                                ...
                                <div class="flex items-center justify-between mt-4">
                                <div class="w-full md:w-full px-3 mb-6">
                                <input type="submit" id="submit" name="submit" value="Cadastrar-se" class="focus:ring-2 focus:ring-offset-2  text-sm font-semibold leading-none text-white focus:outline-none border rounded  py-4 w-full" style="background-image: linear-gradient(to right top, #c9004f, #e8413f, #fa712b, #ffa00d, #fbcf00);"/>
                                </div>
                            </div>
                        </div>
                    </div>
