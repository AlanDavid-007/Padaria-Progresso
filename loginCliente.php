...
<body style="background-image: linear-gradient(to right top, #c9004f, #e8413f, #fa712b, #ffa00d, #fbcf00);">
  ...
  <header id="header" class="header d-flex align-items-center" style="background-color:#0e1d34;">
    ...
    <!-- login -->
    <div class="h-full bg-gradient-to-tl from-black-400 to-gray-900 w-full py-16 px-4 mb-4">
        <div class="flex flex-col items-center justify-center">
            ...
            <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                ...
                <p tabindex="0" class="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">Você não tem uma conta? <a href="./Cadastro_Usuarios.php" class="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none  text-gray-800 cursor-pointer"> Clique aqui.</a></p>
        ...
        <input type="submit" name="submit" value="Logar!" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full"/>
                ...
                <div>
                    ...
                    <div class="mt-8">
                    <input type="submit" id="submit" name="submit" value="Entrar" class="focus:ring-2 focus:ring-offset-2  text-sm font-semibold leading-none text-white focus:outline-none border rounded  py-4 w-full" style="background-image: linear-gradient(to right top, #c9004f, #e8413f, #fa712b, #ffa00d, #fbcf00);"/>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="dark:bg-gray-800 bg-gray-50 px-6 py-9">
          <div class="container-fluid">
            <div class="row  ">
              ...
              <div class="col -sm-4 col -xs-6 " style="margin:auto;">
